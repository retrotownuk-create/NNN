  ...
  if (skuType === 'sku190') {
    ...
    const buildSupport190 = (x: number, type: 'left' | 'right') => {
      ...
      return (
        <group key={type}>
          {/* Wall Flange at Top */}
          <group position={[sideX, e * 2, -e]}>
            <Flange position={[x, height, zWall]} rotation={[Math.PI / 2, 0, 0]} showLabel={showLabel} colorOption={colorOption} />
          </group>
          {/* Depth Pipe */}
          <group position={[sideX, e * 2, -e * 0.5]}>
            <Pipe start={[x, height, zWall + 1.5]} end={[x, height, -1.5]} showLabel={showLabel} colorOption={colorOption} />
          </group>
          {/* Top 90 Elbow - pointing DOWN */}
          <group position={[sideX, e * 2, 0]}>
            <Elbow position={[x, height, 0]} rotation={[0, Math.PI, 0]} showLabel={showLabel} colorOption={colorOption} />
          </group>
          {/* Drop vertical Pipe */}
          <group position={[sideX, e, 0]}>
            <Pipe start={[x, height - 1.5, 0]} end={[x, height - vertCut + 1.5, 0]} showLabel={showLabel} colorOption={colorOption} />
          </group>
          {/* Bottom 90 Elbow - pointing INWARD (towards center) */}
          <group position={[sideX, 0, 0]}>
            <Elbow position={[x, height - vertCut, 0]} rotation={[type === 'left' ? 0 : 0, 0, type === 'left' ? -Math.PI/2 : Math.PI/2]} showLabel={showLabel} colorOption={colorOption} />
          </group>
        </group>
      );
    };
    ...
    return (
      <group position={[0, 0, 0]}>
        ...
        {horizCut > 120 ? (
          <>
            <group position={[-explode * 0.75, 0, 0]}>
              <Pipe start={[leftX + 1.5, height - vertCut, 0]} end={[0, height - vertCut, 0]} showLabel={showLabel} colorOption={colorOption} />
            </group>
            <group position={[0, 0, 0]}>
              <Coupling position={[0, height - vertCut, 0]} rotation={[0, 0, Math.PI / 2]} showLabel={showLabel} colorOption={colorOption} />
            </group>
            <group position={[explode * 0.75, 0, 0]}>
              <Pipe start={[0, height - vertCut, 0]} end={[rightX - 1.5, height - vertCut, 0]} showLabel={showLabel} colorOption={colorOption} />
            </group>
          </>
        ) : (
          <group position={[0, 0, 0]}>
            <Pipe start={[leftX + 1.5, height - vertCut, 0]} end={[rightX - 1.5, height - vertCut, 0]} showLabel={showLabel} colorOption={colorOption} />
          </group>
        )}
        ...
        {hasShelves && (
          <group position={[0, explode * 2.5, 0]}>
            {/* Shelf sits ON the wall connector depth pipes. Pipes are at y=height. Radius is 1.65 roughly. */}
            <Shelf position={[0, height + 1.6, zWall / 2 + 2.1]} length={length} depth={23} woodColor={woodColor} />
          </group>
        )}
      </group>
    );
...
const Scene = React.memo(({ length, height, wallDistance, explode, hasShelves, isFreestanding, colorOption, skuType, woodColor, cameraState, tiers = 4, tubeType = 'round' }: { length: number, height: number, wallDistance: number, explode: number, hasShelves: boolean, isFreestanding: boolean, colorOption: ColorOption, skuType: 'standard' | 'sku777' | 'sku000' | 'sku100' | 'sku200' | 'sku102' | 'sku103' | 'sku104' | 'sku4210' | 'sku300' | 'sku105' | 'sku106' | 'sku107' | 'sku108' | 'sku109' | 'sku110' | 'sku111' | 'sku112' | 'sku113' | 'sku114' | 'sku115' | 'sku116' | 'sku117' | 'sku118' | 'sku119' | 'sku120' | 'sku121' | 'sku122' | 'sku123' | 'sku124' | 'sku125' | 'sku126' | 'sku127' | 'sku128' | 'sku129' | 'sku130' | 'sku131' | 'sku132' | 'sku133' | 'sku134' | 'sku135' | 'sku136' | 'sku137' | 'sku138' | 'sku140' | 'sku141' | 'sku142' | 'sku143' | 'sku144' | 'sku145' | 'sku146' | 'sku147' | 'sku148' | 'sku149' | 'sku150' | 'sku151' | 'sku152' | 'sku153' | 'sku154' | 'sku155' | 'sku156' | 'sku157' | 'sku158' | 'sku159' | 'sku160' | 'sku161' | 'sku162' | 'sku163' | 'sku164' | 'sku165' | 'sku166' | 'sku167' | 'sku168' | 'sku169' | 'sku170' | 'sku171' | 'sku172' | 'sku173' | 'sku174' | 'sku175' | 'sku176' | 'sku177' | 'sku178' | 'sku179' | 'sku180' | 'sku181' | 'sku182' | 'sku183' | 'sku184' | 'sku186' | 'sku888', woodColor: string, cameraState?: any, tiers?: number, tubeType?: 'round' | 'square' }) => {
  return (
    <>
...
export default function App() {
  ...
  const [skuType, setSkuType] = useState<'standard' | 'sku777' | 'sku000' | 'sku100' | 'sku200' | 'sku102' | 'sku103' | 'sku104' | 'sku4210' | 'sku300' | 'sku105' | 'sku106' | 'sku107' | 'sku108' | 'sku109' | 'sku110' | 'sku111' | 'sku112' | 'sku113' | 'sku114' | 'sku115' | 'sku116' | 'sku117' | 'sku118' | 'sku119' | 'sku120' | 'sku121' | 'sku122' | 'sku123' | 'sku124' | 'sku125' | 'sku126' | 'sku127' | 'sku128' | 'sku129' | 'sku130' | 'sku131' | 'sku132' | 'sku133' | 'sku134' | 'sku135' | 'sku136' | 'sku137' | 'sku138' | 'sku140' | 'sku141' | 'sku142' | 'sku143' | 'sku144' | 'sku145' | 'sku146' | 'sku147' | 'sku148' | 'sku149' | 'sku150' | 'sku151' | 'sku152' | 'sku153' | 'sku154' | 'sku155' | 'sku156' | 'sku157' | 'sku158' | 'sku159' | 'sku160' | 'sku161' | 'sku162' | 'sku163' | 'sku164' | 'sku165' | 'sku166' | 'sku167' | 'sku168' | 'sku169' | 'sku170' | 'sku171' | 'sku172' | 'sku173' | 'sku174' | 'sku175' | 'sku176' | 'sku177' | 'sku178' | 'sku179' | 'sku180' | 'sku181' | 'sku182' | 'sku183' | 'sku184' | 'sku186' | 'sku888'>('standard');
  ...
  type SavedSKU = { name: string; length: number; height: number; wallDistance: number; hasShelves: boolean; isFreestanding: boolean; colorName: string; woodColor?: string; skuType?: 'standard' | 'sku777' | 'sku000' | 'sku100' | 'sku200' | 'sku102' | 'sku103' | 'sku104' | 'sku4210' | 'sku300' | 'sku105' | 'sku106' | 'sku107' | 'sku108' | 'sku109' | 'sku110' | 'sku111' | 'sku112' | 'sku113' | 'sku114' | 'sku115' | 'sku116' | 'sku117' | 'sku118' | 'sku119' | 'sku120' | 'sku121' | 'sku122' | 'sku123' | 'sku124' | 'sku125' | 'sku126' | 'sku127' | 'sku128' | 'sku129' | 'sku130' | 'sku131' | 'sku132' | 'sku133' | 'sku134' | 'sku135' | 'sku136' | 'sku137' | 'sku138' | 'sku140' | 'sku141' | 'sku142' | 'sku143' | 'sku144' | 'sku145' | 'sku146' | 'sku147' | 'sku148' | 'sku149' | 'sku150' | 'sku151' | 'sku152' | 'sku153' | 'sku154' | 'sku155' | 'sku156' | 'sku157' | 'sku158' | 'sku159' | 'sku160' | 'sku161' | 'sku162' | 'sku163' | 'sku164' | 'sku165' | 'sku166' | 'sku167' | 'sku168' | 'sku169' | 'sku170' | 'sku171' | 'sku172' | 'sku173' | 'sku174' | 'sku175' | 'sku176' | 'sku177' | 'sku178' | 'sku179' | 'sku180' | 'sku181' | 'sku182' | 'sku183' | 'sku184' | 'sku186' | 'sku888'; tiers?: number; tubeType?: 'round' | 'square' };
          ...
          <div className="lg:absolute lg:top-6 lg:left-6 z-10 bg-white/90 lg:backdrop-blur-xl lg:rounded-[32px] lg:shadow-2xl w-full lg:w-[340px] border-b lg:border border-gray-200 lg:border-white/40 flex flex-col lg:max-h-[calc(100vh-3rem)] overflow-visible lg:overflow-hidden order-2 lg:order-none shrink-0 rounded-none shadow-sm">
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  {((skuType as string) === 'standard' || skuType === 'sku000' || skuType === 'sku100' || skuType === 'sku4210' || skuType === 'sku105' || skuType === 'sku114' || skuType === 'sku116' || skuType === 'sku112' || skuType === 'sku111' || skuType === 'sku113' || skuType === 'sku117' || skuType === 'sku118' || skuType === 'sku119' || skuType === 'sku120' || skuType === 'sku121' || skuType === 'sku122' || skuType === 'sku123' || skuType === 'sku126' || skuType === 'sku127' || skuType === 'sku128' || skuType === 'sku130' || skuType === 'sku131' || skuType === 'sku132' || skuType === 'sku133' || skuType === 'sku135' || skuType === 'sku145' || skuType === 'sku150' || skuType === 'sku180' || skuType === 'sku181' || skuType === 'sku182' || skuType === 'sku183' || skuType === 'sku184' || skuType === 'sku186' || skuType === 'sku187' || skuType === 'sku188' || skuType === 'sku189' || skuType === 'sku189' || skuType === 'sku190') && (
                    <div>
                      ...
                      <input
                        type="range"
                        min={skuType === 'sku119' || skuType === 'sku180' || skuType === 'sku181' || (skuType === 'sku182' || skuType === 'sku183' || skuType === 'sku184' || skuType === 'sku186' || skuType === 'sku187' || skuType === 'sku188' || skuType === 'sku189' || skuType === 'sku189' || skuType === 'sku190') ? 5 : skuType === 'sku116' || skuType === 'sku133' ? 5 : skuType === 'sku122' ? 2 : skuType === 'sku128' ? 15 : 20} max={skuType === 'sku122' ? 10 : skuType === 'sku133' ? 30 : skuType === 'sku128' ? 100 : 250} step={skuType === 'sku122' || skuType === 'sku133' ? 1 : 5}
                        value={height}
              ...
              <section className="space-y-4">
                ...
                {(skuType === 'standard' || skuType === 'sku107' || skuType === 'sku108' || skuType === 'sku109' || skuType === 'sku110' || skuType === 'sku115' || skuType === 'sku127' || skuType === 'sku128' || skuType === 'sku131' || skuType === 'sku133' || skuType === 'sku137' || skuType === 'sku146' || skuType === 'sku156' || skuType === 'sku157' || skuType === 'sku158' || skuType === 'sku177' || skuType === 'sku189' || skuType === 'sku190') && (
                  <>
                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-2xl border border-gray-100">
                      <div className="flex items-center gap-2">
